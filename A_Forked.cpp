...
inline void solve()
{
    ...
    set<pair<int, int>> allPos1;
    allPos.emplace(xq - b, yq + a);
    allPos.emplace(xq - b, yq - a);
    allPos.emplace(xq + b, yq + a);
    allPos.emplace(xq + b, yq - a);
    allPos.emplace(xq + a, yq + b);
    allPos.emplace(xq + a, yq - b);
    allPos.emplace(xq - a, yq + b);
    allPos.emplace(xq - a, yq - b);

    allPos1.emplace(xk - b, yk + a);
    allPos1.emplace(xk - b, yk - a);
    allPos1.emplace(xk + b, yk + a);
    allPos1.emplace(xk + b, yk - a);
    allPos1.emplace(xk + a, yk + b);
    allPos1.emplace(xk + a, yk - b);
    allPos1.emplace(xk - a, yk + b);
    allPos1.emplace(xk - a, yk - b);
    ...
    {
        debug(i);
        pos[{i.first, i.second}] = 1;
    }
    int ans = 0;
    for (auto i : allPos1)
    {
        if (pos[{i.first, i.second}])
            ans++;
    }
    cout << ans << endl;
}
